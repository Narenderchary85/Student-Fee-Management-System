...
const Login = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            const response = await axios.post('https://sms-b-oaox.onrender.com/auth/login', loginData);
    ...
    if (loggedIn) {
        return <Navigate to='/studentlist' />;
    }
        ...
        >
            <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
                ...
                >
                    ...
                    >
                        <div className="text-3xl font-bold bg-gradient-to-r from-blue-500 to-blue-600 bg-clip-text text-transparent mb-4">
                            Student Login
                        </div>
                    </motion.div>
                ...
                >
                    ...
                    <form onSubmit={submitHandler} className="space-y-6">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            disabled={loading}
                            className={`w-full py-3 px-4 cursor-pointer rounded-lg font-medium text-white ${loading ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'} transition flex items-center justify-center`}
                        >
                            {loading ? (
                                <>
                        ...
                        <div className="mt-4">
                            <Link to="/signup">
                                <motion.button
                                    ...
                                    whileHover={{ scale: 1.02 }}
                                    whileTap={{ scale: 0.98 }}
                                    className="w-full py-2 px-4 cursor-pointer border border-gray-300 rounded-lg font-medium text-blue-600 hover:bg-gray-50 transition"
                                >
                                    Sign Up
                                </motion.button>
                            </Link>
